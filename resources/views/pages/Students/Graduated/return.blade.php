    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 style="font-family: 'Cairo', sans-serif;" class="modal-title" id="exampleModalLabel">Return Student </h5>
            ...
            <div class="modal-body">
                <form action="{{route('graduated.update','test')}}" method="post" autocomplete="off">
                    ...
                    <h5 style="font-family: 'Cairo', sans-serif;">Are you sure about the graduation cancellation process?
                    </h5>
