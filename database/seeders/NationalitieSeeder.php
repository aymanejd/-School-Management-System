...
class NationalitieSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $filteredData = array_filter($nationals, function($value) {
            return isset($value['en']);
        }, ARRAY_FILTER_USE_KEY);
        $nationalsValues = array_values($filteredData);

        // Create Nationalitie models from the filtered data
        foreach ($nationals as $n) {
            Nationalitie::create(['Name' => $n['en']]);
        }
